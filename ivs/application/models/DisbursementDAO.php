...
class DisbursementDAO extends DataAccessObject {
	  ...
	  * @return \UserDO
	  */
	 protected function populateDisbursementRecordDO(DisbursementRecordDO $udo, array $row) {
	 ...
	 public function next(\DataObject $do = null) {
		  if (is_null($do)) {
		   $do = DOFactory::getInstance()->createDO(DOEnum::DisbursementRecordDO);
		  }
