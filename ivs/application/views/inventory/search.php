...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Inventory - Search</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
...
?>
         ...
         <?php 
              ...
              <div class="input-group custom-search-form" style="padding-top: 20px; padding-bottom: 20px;">
...
/*
             $i = 1;
             $udo = null;
             while ($inventorylist->hasMoreInventory()) {
