...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">All Reorders</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
    ...
    <div class="jumbotron" style="padding-left: 20px;">
       <?php 
        ...
        echo '<div>'.anchor('reorder/new' ,' New Reorder',array('class'=>'btn btn-primary glyphicon glyphicon-plus','role'=>'button'));
           ...
           <tbody>
            <?php 
             ...
             while ($reorderlist->hasMore()) {
              ...
              echo '<td>' .anchor('reorder/edit/'.$udo->getReorderid(),'View' ) . '</td>';
